...
public class PointLight extends PositionalLight {
     ...
     */
    public PointLight(noshanabi.game.Box2DLightExtension.RayHandler rayHandler, int rays) {
     ...
     */
    public PointLight(noshanabi.game.Box2DLightExtension.RayHandler rayHandler, int rays, Color color,
    ...
    public void setDistance(float dist) {
        dist *= noshanabi.game.Box2DLightExtension.RayHandler.gammaCorrectionParameter;
