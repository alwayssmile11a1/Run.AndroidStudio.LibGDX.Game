...
public abstract class PositionalLight extends Light {
     ...
     * {@link noshanabi.game.Box2DLightExtension.RayHandler} instance.
     *
     * @param rayHandler
     ...
     */
    public PositionalLight(noshanabi.game.Box2DLightExtension.RayHandler rayHandler, int rays, Color color, float distance, float x, float y, float directionDegree) {
