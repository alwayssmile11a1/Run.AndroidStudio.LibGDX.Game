package noshanabi.game.Box2DLightExtension;
...
public class RayHandler implements Disposable {
     ...
     */
    final Array<noshanabi.game.Box2DLightExtension.Light> lightList = new Array<noshanabi.game.Box2DLightExtension.Light>(false, 16);
     ...
     * <p>NOTE: DO NOT MODIFY THIS LIST
     */
    final Array<noshanabi.game.Box2DLightExtension.Light> disabledLights = new Array<noshanabi.game.Box2DLightExtension.Light>(false, 16);

    noshanabi.game.Box2DLightExtension.LightMap lightMap;
    ...
    public RayHandler(World world, int fboWidth, int fboHeight) {
        ...
        lightShader = noshanabi.game.Box2DLightExtension.LightShader.createLightShader();
    }
    ...
    public void resizeFBO(int fboWidth, int fboHeight) {
        ...
        lightMap = new noshanabi.game.Box2DLightExtension.LightMap(this, fboWidth, fboHeight);
    }
     ...
     */
    public void update() {
        for (noshanabi.game.Box2DLightExtension.Light light : lightList) {
            light.update();
        }
    }
     ...
     * Override this if you are using custom light shader
     */
    protected void updateLightShaderPerLight (noshanabi.game.Box2DLightExtension.Light light) {
    ...
    public void removeAll() {
        ...
        for (noshanabi.game.Box2DLightExtension.Light light : disabledLights) {
            light.dispose();
        }
